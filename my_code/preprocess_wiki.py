...
if __name__ == '__main__':
    ...
    parser.add_argument('--dump_path', type=str,default='/mnt/large_storage/hkb/downloads/zhwiki-latest-pages-articles1.xml-p1p187712.bz2')
    parser.add_argument('--seg_size', default=None, type=int)
    parser.add_argument('--stride', default=None, type=int)
    parser.add_argument('--num_workers', default=4, type=int)
    parser.add_argument('--save_path', type=str, default='/mnt/large_storage/hkb/downloads/education.jsonl')
